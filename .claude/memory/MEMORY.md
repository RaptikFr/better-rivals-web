...
- [Roadmap idées juin 2026](roadmap-idees-juin-2026.md) — **PAUSE 18/06 (reprise PC fixe)**. LIVRÉ : réglage n°1 + bibliothèque réglages (+modale). RESTE : brique télémétrie (secteurs→delta→coach→copilote), pack social (duels/config semaine/webhook Discord), régularité, écuries, check version relais. À TESTER : relais v1.11.0 sur PC fixe. Saisons + détection circuit ABANDONNÉES
