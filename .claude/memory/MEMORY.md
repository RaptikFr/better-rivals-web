...
- [Domaine & Resend](domaine-et-resend.md) — domaine canonique = better-rivals-fh6.org (lib/site.ts) ; expéditeur Resend encore en .gg, migrer via RESEND_FROM_EMAIL après vérif DNS
