...
description: "Roadmap site/relais (19/06). LIVRÉ : #6 réglage n°1, #7 bibliothèque réglages+modale, pack social (#8 duels, #10 webhook Discord), #13 check version relais (release v1.11.2). #9 config semaine RETIRÉE le 06/07/2026 (sans intérêt). RESTE : brique télémétrie (secteurs→delta→coach→copilote), #4 régularité, #12 écuries"
metadata: 
  node_type: memory
  type: project
...
- ~~Reste optionnel côté proprio : poser la 1re config de la semaine~~ → **feature #9 RETIRÉE le 06/07/2026** (voir #9 ci-dessous).
...
12. **Écuries/équipes** — ⚠️ **ÉCARTÉE le 10/07/2026** (« je ne suis pas pour à l'heure actuelle ») : ne pas reproposer sauf si le proprio relance lui-même. (Idée d'origine : table `crews`, adhésion par code, classement d'équipe, tag écurie sur profil.) NB : le « classement général » sur lequel elle s'appuyait a de toute façon été supprimé (voir [[suppression-classement-general]]).
