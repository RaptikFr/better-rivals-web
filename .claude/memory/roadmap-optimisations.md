...
- **Phase 3 — maillage élargi : PARTIELLEMENT FAIT.** sitemap async (circuits+voitures) ✅, liens Navbar « Circuits » ✅, /voitures→pages voitures ✅, page voiture→pages circuits ✅. RESTE éventuel : lien depuis /classements vers la page dédiée du circuit sélectionné, footer.
