    ...
    return (
      <main className="min-h-screen flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center space-y-4">
          ...
          <h2 className="text-2xl font-extrabold text-neutral-900 dark:text-white">Message envoyé !</h2>
      ...
      <div className="max-w-xl mx-auto">
        ...
        >
          ...
          <div className="flex-1">
            <p className="text-neutral-900 dark:text-white font-bold text-sm">Rejoindre le Discord</p>
            <p className="text-neutral-600 dark:text-neutral-400 text-sm mt-0.5">Pour une réponse rapide, rejoins la communauté Better Rivals.</p>
          </div>
        ...
        <form
          ...
          className="bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-6 space-y-5"
        >
          ...
          <div>
            <label className="block text-sm font-bold text-neutral-700 dark:text-neutral-300 mb-2">Sujet</label>
            <select
              value={form.sujet}
              onChange={e => setForm(f => ({ ...f, sujet: e.target.value }))}
              className="w-full bg-white dark:bg-neutral-950 border border-neutral-300 dark:border-neutral-700 rounded-lg px-4 py-3 text-neutral-900 dark:text-white focus:outline-none focus:border-pink-500 transition-colors"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              className="w-full bg-white dark:bg-neutral-950 border border-neutral-300 dark:border-neutral-700 rounded-lg px-4 py-3 text-neutral-900 dark:text-white placeholder-neutral-400 dark:placeholder-neutral-600 focus:outline-none focus:border-pink-500 transition-colors resize-none"
            />
          </div>
