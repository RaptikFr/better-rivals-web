      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10">
          <Link
            ...
            className="inline-flex items-center gap-2 text-sm text-neutral-500 hover:text-neutral-300 transition-colors mb-6"
          >
        ...
        <div className="space-y-5 mb-10">
          {CRITERES.map((c) => (
            <div key={c.titre} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="bg-green-500/5 border border-green-500/20 rounded-lg px-4 py-3">
                      ...
                      <p className="text-xs text-neutral-400">{c.exemple}</p>
                    </div>
                    <div className="bg-red-500/5 border border-red-500/20 rounded-lg px-4 py-3">
                      <p className="text-xs font-bold text-red-500 mb-1">❌ Non valide</p>
                      <p className="text-xs text-neutral-400">{c.contreExemple}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Note de validation */}
        <div className="bg-neutral-900 border border-violet-500/30 rounded-xl p-5 mb-8">
          <div className="flex items-start gap-3">
            <span className="text-xl mt-0.5">ℹ️</span>
            <div>
              <h3 className="font-bold text-white mb-1">Processus de validation</h3>
